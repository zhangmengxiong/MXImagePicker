...
internal class MXSQLiteOpenHelper(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, 2) {
    companion object {
        internal const val DB_NAME = "mx_image_picker_db_v2"
        internal const val DB_KEY_DIR = "picker_dir"
